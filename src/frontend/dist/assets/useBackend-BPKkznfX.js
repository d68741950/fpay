...
const AuthError = Variant({
  "userNotFound": Null,
  "phoneTaken": Null,
  "invalidCredentials": Null
});
const Result_1 = Variant({ "ok": UserPublic, "err": AuthError });
...
const SendMoneyRequest = Record({
  "pin": Text,
  "receiverIdentifier": Text,
  "amount": Nat,
  "senderId": UserId
});
const TxError = Variant({
...
const Result = Variant({ "ok": Transaction, "err": TxError });
Service({
  "applyInterest": Func([UserId], [Result_2], []),
  "getBalance": Func([UserId], [Opt(Nat)], ["query"]),
  "getTransactions": Func([UserId], [Vec(Transaction)], ["query"]),
  "getUser": Func([Text], [Opt(UserPublic)], ["query"]),
  "login": Func([LoginRequest], [Result_1], []),
  "register": Func([RegisterRequest], [Result_1], []),
  "sendMoney": Func([SendMoneyRequest], [Result], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const LoginRequest2 = IDL2.Record({ "password": IDL2.Text, "phone": Phone2 });
  const AuthError2 = IDL2.Variant({
    "userNotFound": IDL2.Null,
    "phoneTaken": IDL2.Null,
    "invalidCredentials": IDL2.Null
  });
  const Result_12 = IDL2.Variant({ "ok": UserPublic2, "err": AuthError2 });
  ...
  const SendMoneyRequest2 = IDL2.Record({
    "pin": IDL2.Text,
    "receiverIdentifier": IDL2.Text,
    "amount": IDL2.Nat,
    "senderId": UserId2
  });
  const TxError2 = IDL2.Variant({
    "insufficientBalance": IDL2.Null,
    "selfTransfer": IDL2.Null,
    "invalidPin": IDL2.Null,
    "senderNotFound": IDL2.Null,
    "invalidAmount": IDL2.Null,
    "receiverNotFound": IDL2.Null
  });
  const Result2 = IDL2.Variant({ "ok": Transaction2, "err": TxError2 });
  return IDL2.Service({
    "applyInterest": IDL2.Func([UserId2], [Result_22], []),
    "getBalance": IDL2.Func([UserId2], [IDL2.Opt(IDL2.Nat)], ["query"]),
    "getTransactions": IDL2.Func([UserId2], [IDL2.Vec(Transaction2)], ["query"]),
    "getUser": IDL2.Func([IDL2.Text], [IDL2.Opt(UserPublic2)], ["query"]),
    "login": IDL2.Func([LoginRequest2], [Result_12], []),
    "register": IDL2.Func([RegisterRequest2], [Result_12], []),
    "sendMoney": IDL2.Func([SendMoneyRequest2], [Result2], [])
  });
};
class Backend {
...
function from_candid_AuthError_n7(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n8(_uploadFile, _downloadFile, value);
}
function from_candid_Result_1_n5(_uploadFile, _downloadFile, value) {
...
function from_candid_TxError_n11(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n12(_uploadFile, _downloadFile, value) {
  return "insufficientBalance" in value ? "insufficientBalance" : "selfTransfer" in value ? "selfTransfer" : "invalidPin" in value ? "invalidPin" : "senderNotFound" in value ? "senderNotFound" : "invalidAmount" in value ? "invalidAmount" : "receiverNotFound" in value ? "receiverNotFound" : value;
}
...
function from_candid_variant_n8(_uploadFile, _downloadFile, value) {
  return "userNotFound" in value ? "userNotFound" : "phoneTaken" in value ? "phoneTaken" : "invalidCredentials" in value ? "invalidCredentials" : value;
}
...
function useBackend() {
  ...
  const sendMoney = reactExports.useCallback(
    async (senderId, receiverIdentifier, amount, pin, _note) => {
      if (!actor)
        return {
          success: false,
          error: "App is loading. Please try again shortly."
  ...
  const getBalance = reactExports.useCallback(
    async (userId) => {
  ...
  const getTransactions = reactExports.useCallback(
    async (userId) => {
      if (!actor) return [];
      try {
  ...
  const getUser = reactExports.useCallback(
    async (identifier) => {
      if (!actor) return null;
      try {
  ...
  const applyInterest = reactExports.useCallback(
    async (userId) => {
      if (!actor) return null;
      try {
