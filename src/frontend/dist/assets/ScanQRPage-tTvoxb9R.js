import { c as createLucideIcon, g as getDefaultExportFromCjs, d as commonjsGlobal, r as reactExports, u as useNavigate, j as jsxRuntimeExports } from "./index-Cw2-XxwA.js";
import { L as LoaderCircle, B as Button } from "./Button-B7lkZ5NA.js";
...
const FlipHorizontal2 = createLucideIcon("flip-horizontal-2", __iconNode$1);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function useQRScanner(options) {
  ...
  const [currentFacing, setCurrentFacing] = reactExports.useState(facingMode);
...
function ScanQRPage() {
  ...
  const [scanned, setScanned] = reactExports.useState(null);
  const [resolvedUser, setResolvedUser] = reactExports.useState(null);
  const [resolving, setResolving] = reactExports.useState(false);
  const [resolveError, setResolveError] = reactExports.useState("");
  const {
    qrResults,
    isScanning,
    isActive,
  ...
  const resolveId = reactExports.useCallback(
    async (id) => {
      setResolving(true);
      setResolveError("");
  ...
  const handleProceed = reactExports.useCallback(() => {
    const id = (resolvedUser == null ? void 0 : resolvedUser.userId) ?? scanned;
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-display font-bold text-foreground", children: "Scan QR Code" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Point camera at recipient's QR code" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1 p-1 bg-muted/50 rounded-xl border border-border", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  className: `flex-1 flex items-center justify-center gap-2 py-2 rounded-lg text-sm font-display font-semibold transition-smooth ${mode === "camera" ? "bg-primary text-primary-foreground shadow-elevated" : "text-muted-foreground hover:text-foreground"}`,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  className: `flex-1 flex items-center justify-center gap-2 py-2 rounded-lg text-sm font-display font-semibold transition-smooth ${mode === "manual" ? "bg-primary text-primary-foreground shadow-elevated" : "text-muted-foreground hover:text-foreground"}`,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: mode === "camera" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Card,
                  {
                    ...
                    children: scanned ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                      motion.div,
                      {
                        ...
                        children: resolving ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3 py-4", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-10 h-10 text-primary animate-spin" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Verifying receiver…" })
                        ] }) : resolveError ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-destructive/15 border-2 border-destructive flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-8 h-8 text-destructive" }) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-1", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-foreground", children: "Receiver Not Found" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "p",
                              {
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-chart-2/20 border-2 border-chart-2 flex items-center justify-center success-pop", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-8 h-8 text-chart-2" }) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-1", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-foreground", children: "QR Code Scanned!" }),
                            resolvedUser && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-2 py-1 px-3 rounded-full bg-chart-2/10 border border-chart-2/30", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "w-3.5 h-3.5 text-chart-2" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-chart-2 font-display font-semibold", children: resolvedUser.name })
                            ] }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-mono break-all", children: scanned })
                          ] }),
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full aspect-square rounded-xl overflow-hidden border border-primary/30 bg-muted/40", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 z-10 pointer-events-none", children: [
                          [
                            "top-4 left-4 border-t-2 border-l-2",
                            "top-4 right-4 border-t-2 border-r-2",
                            "bottom-4 left-4 border-b-2 border-l-2",
                            "bottom-4 right-4 border-b-2 border-r-2"
                          ].map((classes) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                        ...
                        !isActive && !isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex flex-col items-center justify-center gap-3 bg-muted/60 backdrop-blur-sm", children: isSupported === false ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-12 h-12 text-destructive/60" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground text-center px-4", children: "Camera not supported in this browser." })
                        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(ScanLine, { className: "w-12 h-12 text-primary/40" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground text-center px-4", children: "Tap start to activate camera" })
                        ] }) }),
                        isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center bg-muted/60", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full border-2 border-primary/30 border-t-primary animate-spin" }) })
                      ] }),
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3 w-full", children: !isActive ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Button,
                        {
                          fullWidth: true,
                        ...
                        isMobile && /* @__PURE__ */ jsxRuntimeExports.jsx(
                          Button,
                          {
                            ...
                            icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FlipHorizontal2, { className: "w-4 h-4" }),
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground text-center", children: [
                        "Logged in as:",
                        " ",
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-mono", children: session == null ? void 0 : session.userId })
                      ] })
                    ] })
                  }
                )
                  ...
                  Card,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-2 text-center", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-full bg-primary/10 border border-primary/30 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Keyboard, { className: "w-6 h-6 text-primary" }) }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Enter a User ID or phone number to send money" })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "label",
                          {
                            ...
                            children: "User ID or Phone Number"
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "input",
                      ...
                      resolveError && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-4 h-4 text-destructive flex-shrink-0 mt-0.5" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-destructive", children: resolveError })
                          ]
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Button,
                        {
                          ...
                          loading: resolving,
                          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ScanLine, { className: "w-4 h-4" }),
                          "data-ocid": "scanqr.proceed_button",
                          children: "Proceed to Send"
                        }
                      )
                    ]
                  }
