import { ad as useRouterState, c as createLucideIcon, u as useNavigate, r as reactExports, j as jsxRuntimeExports } from "./index-Cw2-XxwA.js";
...
import { S as Share2, D as Download } from "./share-2-vWOJFBo9.js";
...
function ReceiptPage() {
  ...
  const [chimeReady, setChimeReady] = reactExports.useState(false);
  const tx = ((_a = location.state) == null ? void 0 : _a.txId) ? location.state : void 0;
  ...
  const handleScreenshot = async () => {
    ...
    try {
      ...
      a2.href = url;
      a2.download = `fpay-demo-receipt-${(tx == null ? void 0 : tx.txId) ?? "receipt"}.png`;
      a2.click();
  ...
  const handleShare = async () => {
    ...
    try {
      ...
      if (blob && navigator.share) {
        ...
        const canShareFile = (_a2 = navigator.canShare) == null ? void 0 : _a2.call(navigator, { files: [file] });
        if (canShareFile) {
          await navigator.share({
            title: "FPay Demo Receipt",
            text: `DEMO PAYMENT: ₹${amountNum.toFixed(2)} sent to ${tx == null ? void 0 : tx.receiverId}. THIS IS A DEMO – NOT REAL.`,
            files: [file]
          });
          return;
        }
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-muted flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-8 h-8 text-muted-foreground" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground font-display font-semibold", children: "No receipt found" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground text-center", children: "Complete a transaction to see your receipt here." }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-sm pt-4 pb-2 flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-display font-semibold text-muted-foreground tracking-wide uppercase", children: "Payment Receipt" })
        ] }),
            ...
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Card,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-40 h-40 rounded-full bg-primary/10 blur-3xl pointer-events-none" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3 pt-4 relative", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: chimeReady && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        motion.div,
                        {
                          ...
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-11 h-11 text-chart-2" })
                        },
                        "check"
                      ) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        motion.div,
                        {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-accent font-display font-bold tracking-widest uppercase", children: "DEMO PAYMENT" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-3.5 h-3.5 text-accent" })
                          ]
                        }
                      )
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      motion.div,
                      {
                        ...
                        children: detailRows(tx).map(({ label, value }, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between gap-4", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground font-body flex-shrink-0", children: label }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "span",
                            {
                              className: "text-sm text-foreground font-display font-medium text-right break-all",
                              "data-ocid": `receipt.detail.${i + 1}`,
                              children: label === "Status" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-chart-2/10 text-chart-2 text-xs font-semibold", children: [
                                "✓ ",
                                value
                              ] }) : value
                            }
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      motion.div,
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-accent font-display font-bold tracking-wide uppercase", children: "⚠ This is a simulation-only demo transaction" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body", children: "No real money was transferred. FPay is for educational purposes only." })
                        ]
                      }
                    )
                  ]
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      ...
                      size: "md",
                      fullWidth: true,
                      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(History, { className: "w-4 h-4" }),
